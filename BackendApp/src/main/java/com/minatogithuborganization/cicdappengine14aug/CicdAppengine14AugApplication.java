package com.minatogithuborganization.cicdappengine14aug;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborganization.cicdappengine14aug"})
@EnableCaching
...
public class CicdAppengine14AugApplication {

	public static void main(String[] args) {
		SpringApplication.run(CicdAppengine14AugApplication.class, args);
	}
