...
public class Table12BaseService<T extends Table12Base> extends BaseBusinessLogic<T>
		implements ITable12BaseService<T> {
	...
	public Table12BaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Table12", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Table12", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Table12", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
